...
export const MOBILE_TEMPLATES: Template[] = [
    ...
    steps: ({ projectName, pm }) => [
      {
        ...
        ...dlx(pm, 'create-expo-app@latest', projectName, '--template', 'blank-typescript'),
      },
      installStep(pm),
    ],
  },

  {
    ...
    category: 'mobile',
    name: 'Expo Router',
    description: 'Expo SDK 52 · File-based routing · TypeScript · Tabs template',
    ...
    steps: ({ projectName, pm }) => [
      {
        ...
        ...dlx(pm, '@react-native-community/cli@latest', 'init', projectName, '--template', 'react-native-template-typescript'),
      },
    ],
  },
]
